...
def keyboard_button_randon_followers():
...
def keyboards_button_bac_to_start():
    keyboards = [InlineKeyboardButton(text="Назад", callback_data="back_to_start")]
    return keyboards


def keyboards_button_bac_to_streamers():
    keyboards = [InlineKeyboardButton(text="Назад", callback_data="back_to_streamers")]
    return keyboards
